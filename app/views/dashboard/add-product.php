...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!empty($_POST['code']) && !empty($_POST['description']) && !empty($_POST['category']) && !empty($_POST['precio']) && !empty($_POST['stock'])) {
		...
		if (!(Producto::searchProductNotBool($newProduct->getCodigo()))) {
			
			if ($newProduct->register()) {
				$messages[] = "Producto Registrado Exitosamente";
			}else {
                $errors[] = "Ocurrio Un Error Intente Nuevamente";
            }
		}else {
			$errors[] = "Codigo no Disponible";
		}
                                    ...
                                    <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Codigo del Producto" name="code" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                <div class="mb-3">
                                                                    <label class="form-label">Descripción <span
                                                                            class="text-red">*</span></label>
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="col-sm-6 col-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="precio" pattern="^\d+(\.\d{1,2})?$" title="Por favor, introduce un número decimal con máximo 2 decimales" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                <div class=" mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        placeholder="Cantidad Disponible" name="stock" min="1" max="999" required>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="col-sm-12 col-12">
                                            <div class="custom-btn-group flex-end">
                                                <button class="btn btn-success">Anadir Producto</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
